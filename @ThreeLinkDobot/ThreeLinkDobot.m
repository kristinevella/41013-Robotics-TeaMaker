classdef ThreeLinkDobot < handle
    properties
        %Logger
...
function self = ThreeLinkDobot(useGripper)
...
%% GetDobotRobot
% Given a name (optional), create and return a 3 Link Dobot robot model
% with linear rail
...
function PlotAndColourRobot(self)%robot,workspace)
    ...
    % Display robot
    self.model.plot3d([0,0,pi/4,pi/4],'noarrow','workspace',self.workspace);
